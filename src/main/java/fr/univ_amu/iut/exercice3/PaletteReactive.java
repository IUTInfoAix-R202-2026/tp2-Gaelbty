...
public class PaletteReactive extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    BoutonCouleur rouge = new BoutonCouleur("Rouge", "red");
    rouge.setId("btn-rouge");
    BoutonCouleur vert = new BoutonCouleur("Vert", "green");
    vert.setId("btn-vert");
    BoutonCouleur bleu = new BoutonCouleur("Bleu", "blue");
    bleu.setId("btn-bleu");
    ...
    createBindings(rouge, vert, bleu, zone, labelCompteurs);
